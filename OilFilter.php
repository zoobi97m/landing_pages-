...
<html>
    ...
    <body>
            ...
            <script type="text/javascript">
                ...
                function handleResize(event)
                {
                    if($(window).width() <= 550)
                    {
                        ...
                        $("#bg_img_of").css("height", "50vh");
                        $("#bg_img_of").css("max-width", "100%");
                    ...
                    else 
                    {
                         ...
                         $("#burger_menu_top").hide();
                          $("#bg_img_of").css("height", "60vh");
                        $("#bg_img_of").css("max-width", "35%");
        ...
        <div id = "bg_img_of" class = " container bg-img">
        </div>
