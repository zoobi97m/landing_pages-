...
<html>
    ...
    <body>
            ...
            <script type="text/javascript">
                ...
                function handleResize(event)
                {
                    if($(window).width() <= 550)
                    {
                        ...
                        $("#bg_img_ff").css("height", "50vh");
                        $("#bg_img_ff").css("max-width", "100%");
                    ...
                    else 
                    {
                         ...
                         $("#burger_menu_top").hide();
                          $("#bg_img_ff").css("height", "60vh");
                        $("#bg_img_ff").css("max-width", "40%");
        ...
        <div id = "bg_img_ff" class = " container bg-img">
        </div>
